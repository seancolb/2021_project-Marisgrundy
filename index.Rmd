...
```{r, warning=FALSE, message=FALSE, eval=FALSE, warning=FALSE}
...
There is evidence of a relationship between mean income and proximity to a wetland within census tracts in Erie County.  In the maps displaying wetland distribution and proximity to wetlands, close proximity excludes the downtown core in the City of Buffalo.  The choropleth/bubble map displaying wetland count and median income also shows an inverse relationship between these variables.
